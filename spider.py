...
class PythonListingSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for listing in gallery:
            ...
            listing_details['name'] = listing.xpath('div/a/div/div[@class="si-listing__title-main"]/text()').get()
            listing_details['description'] = listing.xpath('div/a/div/div[@class="si-listing__title-main"]/text()').get()
            listing_details['price'] = listing.xpath('div/div/a/div/span/text()').get()
            listing_details['agency'] = listing.xpath('div/div/div[@class="si-listing__footer"]/div/text()').get()
